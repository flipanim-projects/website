const FlipAnimCreateAccount = function () {
  ...
  function submitHandler() {
    ...
    let reserved = ["VideoGameDude", "Sharkiiie", "Flippy", "Deku-Kun2", "Infinity999", "GearyOGuy", "Starshifter", "Worthings", "Worthlessness", "ViViHelico", "one", "FluffyGraffes", "Bugtoast", "Fazerlazer321", "Ak.", "Thatwaffle99", "wafels", "Its_Dev3230", "Infienthusiastowo", "catarie", "Link", "the-dumb-dino"]
