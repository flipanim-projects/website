const FlipAnimCreateAccount = function () {
  ...
  function submitHandler() {
    ...
    let reserved = ["VideoGameDude", "Sharkiiie", "Flippy", "Deku-Kun2", "Infinity999", "Starshifter", "Worthings", "Worthlessness", "ViViHelico", "one", "FluffyGraffes", "Bugtoast", "Fazerlazer321", "Ak.", "wafels", "Its_Dev3230", "Infienthusiastowo", "catarie", "Link", "the-dumb-dino"]
